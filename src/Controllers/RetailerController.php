    ...
    public function index(Request $request, Response $response) {
        ...
        $sql = "
            SELECT p.id, p.title, p.description, p.brand_name, p.status, p.created_at,
                   ...
                   COALESCE(MIN(pv.image_url), (SELECT pi2.image_url FROM product_images pi2 WHERE pi2.product_id = p.id ORDER BY pi2.is_primary DESC, pi2.id ASC LIMIT 1), '/uploads/products/Bandhej (1).jpg') as image_url, 
